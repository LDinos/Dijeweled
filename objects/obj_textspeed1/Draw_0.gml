...
var value = gamerule_object.blazingspeedchain;
var totalChains = gamerule_object.blazingspeedtotalchain

if totalChains > 0 {
	var t = "x"+string(totalChains)+" match chain";
	...
	var blaze_w = clamp(value/blazing_speed_cap*2-1,0,1)*str_w
