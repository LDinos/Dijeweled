...
if MyGamerule.controlallowed && isready
{
	...
	{	
		...
		if instance_exists(gem1)
		{
			...
			{
				var gems;
				gems[0] = Gamerule_local.gems_id_fallen_array[itodo,jtodo]
				gems[1] = Gamerule_local.gems_id_fallen_array[itodo,jtodo+1]
				gems[2] = Gamerule_local.gems_id_fallen_array[itodo+1,jtodo+1]
				gems[3] = Gamerule_local.gems_id_fallen_array[itodo+1,jtodo]
				var ready = true;			
				for(var i = 0; i<4;i++)
				{
					if (gems[i] == noone)
