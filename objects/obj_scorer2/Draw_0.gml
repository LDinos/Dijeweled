...
draw_text_transformed(x-218,y+30,number_convert_with_commas(points2), 0.85, 0.85, 0)
draw_text_transformed(x-218,y+30 + 32*1,matches2, 0.85, 0.85, 0)
draw_text_transformed(x-218,y+30 + 32*2,number_convert_with_commas(style2), 0.85, 0.85, 0)
draw_set_font(font2)
