	...
	if instance_number(Gem_1) > 10
	{
		repeat(3)
		{
			do
			{
				...
				{
					if (Gamerule_1.gems_id_fallen_array[i][j].amLocked = 0)
					{
						instance_create(Gamerule_1.gems_id_fallen_array[i][j].x,Gamerule_1.gems_id_fallen_array[i][j].y,lock_settling)
						Gamerule_1.gems_id_fallen_array[i][j].amLocked= 1
